...
class TestCreateRoom(unittest.TestCase):
    ...
    def test_office_members_is_empty(self):
      self.assertEqual(self.office_data['neptune'].members,{})
    
    def test_office_no_of_occupants(self):
    ...
    def test_created_living_object(self):
    ...
    def test_create_living_wrong_type_raises_error(self):
    ...
    def test_reallocate_wrong_id_raises_error(self):
      self.assertRaises(Exception, self.amity.reallocate_person, 'ABDCQ','iroko')

    #def test_unallocated(self):
    #  self.amity.add_person('Adedoyin', 'Israel', 'fellow','n')
      
      
    #def test_print_unallocated(self):
    #  self.amity.print_unallocated()
    #  self.assertEqual(sys.stdout.getvalue(), 'ADEDOYIN ISRAEL (FELLOW)\n')
